...
test "test instructions modifies the state of CPU properly" {
    const test_cases = [_]CASE{
        ...
        .{ .OP = 1, .IMM = .{ 0, 128 }, .B = .{ 0, 128 }, .C = .{ 0, 0 }, .PCL = .{ 0, 3 } },
        .{ .OP = 1, .IMM = .{ 0, 255 }, .C = .{ 0, 0 }, .B = .{ 255, 255 }, .PCL = .{ 0, 3 } },
        .{ .OP = 1, .IMM = .{ 1, 1 }, .C = .{ 1, 1 }, .B = .{ 1, 1 }, .PCL = .{ 0, 3 } },
        .{ .OP = 1, .IMM = .{ 127, 255 }, .C = .{ 127, 127 }, .B = .{ 255, 255 }, .PCL = .{ 0, 3 } },
        .{ .OP = 1, .IMM = .{ 128, 0 }, .C = .{ 128, 128 }, .B = .{ 0, 0 }, .PCL = .{ 0, 3 } },
        .{ .OP = 1, .IMM = .{ 15, 240 }, .C = .{ 15, 15 }, .B = .{ 240, 240 }, .PCL = .{ 0, 3 } },
        .{ .OP = 1, .IMM = .{ 170, 85 }, .C = .{ 170, 170 }, .B = .{ 85, 85 }, .PCL = .{ 0, 3 } },
        .{ .OP = 1, .IMM = .{ 240, 15 }, .C = .{ 240, 240 }, .B = .{ 15, 15 }, .PCL = .{ 0, 3 } },
        .{ .OP = 1, .IMM = .{ 255, 0 }, .C = .{ 255, 255 }, .B = .{ 0, 0 }, .PCL = .{ 0, 3 } },
        .{ .OP = 1, .IMM = .{ 255, 255 }, .C = .{ 255, 255 }, .B = .{ 255, 255 }, .PCL = .{ 0, 3 } },
        .{ .OP = 1, .IMM = .{ 52, 18 }, .C = .{ 52, 52 }, .B = .{ 18, 18 }, .PCL = .{ 0, 3 } },
        .{ .OP = 1, .IMM = .{ 66, 105 }, .C = .{ 66, 66 }, .B = .{ 105, 105 }, .PCL = .{ 0, 3 } },
        .{ .OP = 1, .IMM = .{ 85, 170 }, .C = .{ 85, 85 }, .B = .{ 170, 170 }, .PCL = .{ 0, 3 } },
        ...
        .{ .OP = 17, .IMM = .{ 1, 1 }, .D = .{ 1, 1 }, .E = .{ 1, 1 }, .PCL = .{ 0, 3 } },
        .{ .OP = 17, .IMM = .{ 170, 85 }, .E = .{ 170, 170 }, .D = .{ 85, 85 }, .PCL = .{ 0, 3 } },
        .{ .OP = 17, .IMM = .{ 170, 85 }, .E = .{ 170, 170 }, .D = .{ 85, 85 }, .PCL = .{ 0, 3 } },
        .{ .OP = 17, .IMM = .{ 204, 51 }, .E = .{ 204, 204 }, .D = .{ 51, 51 }, .PCL = .{ 0, 3 } },
        .{ .OP = 17, .IMM = .{ 255, 255 }, .E = .{ 255, 255 }, .D = .{ 255, 255 }, .PCL = .{ 0, 3 } },
        .{ .OP = 17, .IMM = .{ 255, 255 }, .E = .{ 255, 255 }, .D = .{ 255, 255 }, .PCL = .{ 0, 3 } },
        .{ .OP = 17, .IMM = .{ 52, 18 }, .E = .{ 52, 52 }, .D = .{ 18, 18 }, .PCL = .{ 0, 3 } },
        .{ .OP = 17, .IMM = .{ 52, 18 }, .E = .{ 52, 52 }, .D = .{ 18, 18 }, .PCL = .{ 0, 3 } },
        ...
        .{ .OP = 33, .IMM = .{ 1, 1 }, .L = .{ 1, 1 }, .H = .{ 1, 1 }, .PCL = .{ 0, 3 } },
        .{ .OP = 33, .IMM = .{ 170, 85 }, .L = .{ 170, 170 }, .H = .{ 85, 85 }, .PCL = .{ 0, 3 } },
        .{ .OP = 33, .IMM = .{ 204, 51 }, .L = .{ 204, 204 }, .H = .{ 51, 51 }, .PCL = .{ 0, 3 } },
        .{ .OP = 33, .IMM = .{ 255, 255 }, .L = .{ 255, 255 }, .H = .{ 255, 255 }, .PCL = .{ 0, 3 } },
        .{ .OP = 33, .IMM = .{ 52, 18 }, .L = .{ 52, 52 }, .H = .{ 18, 18 }, .PCL = .{ 0, 3 } },
    ...
    for (test_cases, 0..) |case, idx| {
        ...
        const h: u32 = @intCast(c.REG[r.PCH]);
        const l: u32 = @intCast(c.REG[r.PCL]);
        const pc: u32 = (h << 8) + l + hw.PROG_START;

        c.REG[pc + 0] = case.OP;
        c.REG[pc + 1] = @intCast(case.IMM[IMM0]);
        c.REG[pc + 2] = @intCast(case.IMM[IMM1]);

        c.run_single_instruction();
