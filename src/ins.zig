...
pub const instructions = [_]instruction_t{
    ...
    instruction_t.init(
        194,
        0xc2,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.LD_IM, mc.MV_MM, mc.JP_NF },
        &[_]t.DataType{ r.PC, r.TML, r.TMH, r.TM, r.ZF },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        195,
        0xc3,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.LD_IM, mc.MV_MM, mc.JP_F },
        &[_]t.DataType{ r.PC, r.TML, r.TMH, r.TM, r.ONS },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        206,
        0xce,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.ADD_R, mc.ADD_R },
        &[_]t.DataType{ r.PC, r.TML, r.TML, r.CF },
        fs.FS_CX,
        fs.FS_HX,
        fs.FS_0,
        fs.FS_ZX,
    ...
    instruction_t.init(
        ...
        0xd2,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.LD_IM, mc.MV_MM, mc.JP_NF },
        &[_]t.DataType{ r.PC, r.TML, r.TMH, r.TM, r.CF },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
