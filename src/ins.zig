...
pub const instructions = [_]instruction_t{
    ...
    instruction_t.init(
        1,
        0x01,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR},
        &[_]t.DataType{ r.PC, r.B, r.PC, r.C, r.PC},
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        2,
        0x02,
        &[_]MCFuncPtr{ mc.LD_R, mc.MV_MM, mc.INC_RR },
        &[_]t.DataType{ r.A, r.BC, r.PC },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        3,
        0x03,
        &[_]MCFuncPtr{mc.INC_RR, mc.INC_RR},
        &[_]t.DataType{r.BC, r.PC},
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        6,
        0x06,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR},
        &[_]t.DataType{ r.PC, r.B, r.PC },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        10,
        0x0a,
        &[_]MCFuncPtr{ mc.LD_MM, mc.MV_R , mc.INC_RR},
        &[_]t.DataType{ r.BC, r.A , r.PC},
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        11,
        0x0b,
        &[_]MCFuncPtr{mc.DEC_RR, mc.INC_RR},
        &[_]t.DataType{r.BC, r.PC},
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        ...
        0x11,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR },
        &[_]t.DataType{ r.PC, r.D, r.PC, r.E, r.PC },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        ...
        0x21,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR },
        &[_]t.DataType{ r.PC, r.H, r.PC, r.L, r.PC },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        34,
        0x22,
        &[_]MCFuncPtr{ mc.MV_MM, mc.INC_RR , mc.INC_RR},
        &[_]t.DataType{ r.HL, r.HL , r.PC},
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        ...
        0x31,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR },
        &[_]t.DataType{ r.PC, r.S, r.PC, r.P, r.PC },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        50,
        0x32,
        &[_]MCFuncPtr{ mc.MV_MM, mc.DEC_RR , mc.INC_RR},
        &[_]t.DataType{ r.HL, r.HL , r.PC},
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        64,
        0x40,
        &[_]MCFuncPtr{ mc.LD_R, mc.MV_R , mc.INC_RR},
        &[_]t.DataType{ r.B, r.B , r.PC},
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        128,
        0x80,
        &[_]MCFuncPtr{mc.ADD_R, mc.INC_RR},
        &[_]t.DataType{r.B, r.PC},
        fs.FS_CX,
        fs.FS_HX,
        fs.FS_0,
        fs.FS_ZX,
    ...
    instruction_t.init(
        134,
        0x86,
        &[_]MCFuncPtr{ mc.LD_MM, mc.ADD_R , mc.INC_RR},
        &[_]t.DataType{ r.HL, r.TM , r.PC},
        fs.FS_CX,
        fs.FS_HX,
        fs.FS_0,
        fs.FS_ZX,
    ...
    instruction_t.init(
        136,
        0x88,
        &[_]MCFuncPtr{ mc.ADD_R, mc.ADD_R , mc.INC_RR},
        &[_]t.DataType{ r.B, r.CF , r.PC},
        fs.FS_CX,
        fs.FS_HX,
        fs.FS_0,
        fs.FS_ZX,
    ...
    instruction_t.init(
        142,
        0x8e,
        &[_]MCFuncPtr{ mc.LD_MM, mc.ADD_R, mc.ADD_R , mc.INC_RR},
        &[_]t.DataType{ r.HL, r.TM, r.CF , r.PC},
        fs.FS_CX,
        fs.FS_HX,
        fs.FS_0,
        fs.FS_ZX,
    ...
    instruction_t.init(
        144,
        0x90,
        &[_]MCFuncPtr{mc.SUB_R, mc.INC_RR},
        &[_]t.DataType{r.B, r.PC},
        fs.FS_CXNEG,
        fs.FS_HX,
        fs.FS_1,
    ...
    instruction_t.init(
        150,
        0x96,
        &[_]MCFuncPtr{ mc.LD_MM, mc.SUB_R, mc.INC_RR },
        &[_]t.DataType{ r.HL, r.TM, r.PC },
        fs.FS_CXNEG,
        fs.FS_HX,
        fs.FS_1,
    ...
    instruction_t.init(
        194,
        0xc2,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.MV_MM, mc.JP_NF },
        &[_]t.DataType{ r.PC, r.TML, r.PC, r.TMH, r.PC, r.TM, r.ZF },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        "JP NZ, a16",
        "Load the 16-bit immediate operand a16 into the program counter PC if the Z flag is 0. If the Z flag is 0, then the subsequent instruction starts at address a16. If not, the contents of PC are incremented, and the next instruction following the current JP instruction is executed (as usual). The second byte of the object code (immediately following the opcode) corresponds to the lower-order byte of a16 (bits 0-7), and the third byte of the object code corresponds to the higher-order byte (bits 8-15).",
    ),
    instruction_t.init(
        195,
        0xc3,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.MV_MM, mc.JP_F },
        &[_]t.DataType{ r.PC, r.TML, r.PC, r.TMH, r.PC, r.TM, r.ONS },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        "JP a16",
        "Load the 16-bit immediate operand a16 into the program counter (PC). a16 specifies the address of the subsequently executed instruction. The second byte of the object code (immediately following the opcode) corresponds to the lower-order byte of a16 (bits 0-7), and the third byte of the object code corresponds to the higher-order byte (bits 8-15).",
    ),
    instruction_t.init(
        196,
        197,
    ...
    instruction_t.init(
        206,
        0xce,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.ADD_R, mc.ADD_R },
        &[_]t.DataType{ r.PC, r.TML, r.PC, r.TML, r.CF },
        fs.FS_CX,
        fs.FS_HX,
        fs.FS_0,
        fs.FS_ZX,
    ...
    instruction_t.init(
        ...
        0xd2,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.MV_MM, mc.JP_NF },
        &[_]t.DataType{ r.PC, r.TML, r.PC, r.TMH, r.PC, r.TM, r.CF },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        "JP NC, a16",
        "Load the 16-bit immediate operand a16 into the program counter PC if the CY flag is 0. If the CY flag is 0, then the subsequent instruction starts at address a16. If not, the contents of PC are incremented, and the next instruction following the current JP instruction is executed (as usual). The second byte of the object code (immediately following the opcode) corresponds to the lower-order byte of a16 (bits 0-7), and the third byte of the object code corresponds to the higher-order byte (bits 8-15).",
    ),
    instruction_t.init(
        211,
        212,
    ...
    instruction_t.init(
        ...
        fs.FS_NOP,
        "JP C, a16",
        "Load the 16-bit immediate operand a16 into the program counter PC if the CY flag is 1. If the CY flag is 1, then the subsequent instruction starts at address a16. If not, the contents of PC are incremented, and the next instruction following the current JP instruction is executed (as usual). The second byte of the object code (immediately following the opcode) corresponds to the lower-order byte of a16 (bits 0-7), and the third byte of the object code corresponds to the higher-order byte (bits 8-15).",
    ),
    instruction_t.init(
        219,
        220,
    ...
    instruction_t.init(
        234,
        0xea,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.MV_MM },
        &[_]t.DataType{ r.PC, r.TML, r.PC, r.TMH, r.PC, r.TM },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        250,
        0xfa,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_R_MM },
        &[_]t.DataType{ r.PC, r.TML, r.PC, r.TMH, r.PC, r.A },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        254,
        0xfe,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.CP },
        &[_]t.DataType{ r.PC, r.TM, r.PC, r.TM },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_1,
        fs.FS_NOP,
