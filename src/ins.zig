...
pub const instructions = [_]instruction_t{
    ...
    instruction_t.init(
        ...
        &[_]t.DataType{ r.PC, r.C, r.PC, r.B, r.PC},
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        2,
        0x02,
        &[_]MCFuncPtr{ mc.STORE_R, mc.MV_MM, mc.INC_RR },
    ...
    instruction_t.init(
        10,
        0x0a,
        &[_]MCFuncPtr{ mc.STORE_MM, mc.LD_R , mc.INC_RR},
    ...
    instruction_t.init(
        ...
        0x11,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR },
        &[_]t.DataType{ r.PC, r.E, r.PC, r.D, r.PC },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        ...
        0x21,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR },
        &[_]t.DataType{ r.PC, r.L, r.PC, r.H, r.PC },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        64,
        0x40,
        &[_]MCFuncPtr{ mc.STORE_R, mc.LD_R , mc.INC_RR},
    ...
    instruction_t.init(
        134,
        0x86,
        &[_]MCFuncPtr{ mc.STORE_MM, mc.ADD_R , mc.INC_RR},
    ...
    instruction_t.init(
        142,
        0x8e,
        &[_]MCFuncPtr{ mc.STORE_MM, mc.ADD_R, mc.ADD_R , mc.INC_RR},
    ...
    instruction_t.init(
        150,
        0x96,
        &[_]MCFuncPtr{ mc.STORE_MM, mc.SUB_R, mc.INC_RR },
        &[_]t.DataType{ r.HL, r.TM, r.PC },
        fs.FS_CXNEG,
        fs.FS_HX,
        fs.FS_1,
    ...
    instruction_t.init(
        194,
        0xc2,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.JP_NF },
        &[_]t.DataType{ r.PC, r.TML, r.PC, r.TMH, r.PC, r.ZF },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        195,
        0xc3,
        &[_]MCFuncPtr{  mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.JP_F },
        &[_]t.DataType{ r.PC,      r.TML,    r.PC,      r.TMH,    r.PC,      r.ONS   },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
    ...
    instruction_t.init(
        ...
        0xd2,
        &[_]MCFuncPtr{ mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.LD_IM, mc.INC_RR, mc.JP_NF },
        &[_]t.DataType{ r.PC, r.TML, r.PC, r.TMH, r.PC, r.CF },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
