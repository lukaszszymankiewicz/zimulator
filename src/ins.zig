...
pub const instructions = [_]instruction_t{
    ...
    instruction_t.init(
        64,
        0x40,
        &[_]MCFuncPtr{ mc.LD_R, mc.MV_R },
        &[_]t.DataType{ r.B, r.B },
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
        fs.FS_NOP,
